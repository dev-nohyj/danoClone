...
import { emailCheck, phoneNumCheck } from '../shared/common';
import { getCookie } from '../shared/Cookie';
import { actionCreators as userActions } from '../redux/modules/user';

// 회원 정보수정 페이지
function Userinfo(props: { history: any }) {
    ...
    // 유효성 검증
    let confirm = true;
    if (password === '' || passwordCheck === '' || userEmail === '' || phoneNum === '') {
        confirm = true;
    } else {
        confirm = false;
    }
    const update = () => {
        ...
        dispatch(userActions.updateUserDB(password, userEmail, phoneNum));
    };
    return (
        <>
            <Header />
