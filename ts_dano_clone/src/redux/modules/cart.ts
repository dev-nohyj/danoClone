...
const buyCartDB = () => {
    return function (dispatch: any, _getState: any, { history }: any) {
        axios({
            method: 'post',
...
const deleteCartDB = (cartId: number | undefined) => {
...
// 장바구니에 추가하기
// 보내는 데이터: 갯수, 제품 id
const addCartDB = (cartItem: { productId: number | undefined; count: number }) => {
